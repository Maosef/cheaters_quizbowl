...
export default class Highlighter extends Component {
    ...
    // if text changes, clear selection
    ...
    onMouseUpHandler(e) {
        ...
        const first = this.props.text.slice(0, selectionStart);
        const middle = this.props.text.slice(selectionStart, selectionEnd);
        const last = this.props.text.slice(selectionEnd);
